...
image1_vertices = mtranslate(-3,0)*transform_vertices(image1_vertices,mrotate(55))
image2_vertices = transform_vertices(image2_vertices, mrotate(55) * mtranslate(-3, 0));
image3_vertices = mtranslate(1,1.75)*transform_vertices(image3_vertices, mrotate(-20) * mscale(2,3)); 
image4_vertices = mscale(1,3)*transform_vertices(image4_vertices, mrotate(45));
