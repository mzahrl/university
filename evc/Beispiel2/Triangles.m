...
P1 = [4;-7;-3]; % TODO: edit this
P2 = [-8;-2;7]; % TODO: edit this
P3 = [-8;-3;-7]; % TODO: edit this
...
P1P2 = [-8-4;-2+7;7+3]; % TODO: edit this
P2P3 = [-8+8;-3+2;0]; % TODO: edit this
P3P1 = [12;10;4]; % TODO: edit this
...
P1P2_length = sqrt(P1P2_saved(1)^2+P1P2_saved(2)^2+P1P2_saved(3)^2); % TODO: edit this
P2P3_length = sqrt(P2P3_saved(1)^2+P2P3_saved(2)^2+P2P3_saved(3)^2); % TODO: edit this
P3P1_length = sqrt(P3P1_saved(1)^2+P3P1_saved(2)^2+P3P1_saved(3)^2); % TODO: edit this
...
Normal = corss(P1P2,P2P3); % TODO: edit this
Normal_normalized = Normal / norm(Normal); % TODO: normalize it!
...
Area = length(cross(P1P2, P3-P1))  ./ 2; % TODO: edit this
