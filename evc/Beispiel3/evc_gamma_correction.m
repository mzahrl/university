...
%   brightness...   brightness of the image
    ...
    brightness = rgb2gray(input ./ max(input(:))) .* max(input(:));
end
...
%   chromaticity...     chromaticity of the image
    ...
    chromaticity = input;
    m = repmat(brigthness, [1 1 3]);
    chromaticity = chromatitcity ./ m;
end
...
%   result...               reconstructed image
	...
	%TODO:  Implement this function.
    m = repmat(brightness_gamma,[1 1 3]);
    result = chromaticity .* m;
end
